	...
	<div id="input-vue-app">
		...
		<div class="row">
			<div class="col-md-3 col-md-offset-1 input-div exercise-input-div">
				<div class="form-group">
					<select name="exercise" class="form-control" id="id-exercise" v-on:change="resetFields()">
						<? foreach ($exercises as $key => $exercise) : ?>
							<option value="<?= $key; ?>" data-unit="<?= $exercise['unit']; ?>" data-name="<?= $exercise['name']; ?>">
								<?= $exercise['name']; ?>
							</option>
						<? endforeach; ?>
					</select>
		...
		<div class="row margin-top">
			<div class="input-div col-md-offset-10 col-md-1">
				<button type="submit" name="submit" id="btn-post-submit" class="btn btn-kintore">
